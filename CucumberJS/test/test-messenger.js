...
describe('Messenger', function() {
    ...
    describe ('Get a friendly day message ', function() {
        it('return a good day message', function(done){
    ...
    describe ('Get a friendly day message ', function() {
        it('return a good afternoon message', function(done){

            //Arrange
            let mesenger;
            mesenger = new Messenger( );
            //Act
            let message =  mesenger.getMessageWithHour(new Date(2020, 02, 11, 12, 0, 0).toTimeString());
            //Assert
    ...
    describe ('Get a friendly day message ', function() {
        it('return a Goodnight message', function(done){

            //Arrange
            let mesenger;
            mesenger = new Messenger( );
            //Act
            let message =  mesenger.getMessageWithHour(new Date(2020, 02, 11, 19, 0, 0).toTimeString());
            //Assert
